...
void CreateSketchFixSupTY(RPArray<MbContour>& _arrContours, float L2, float B1, float h)
{
...
void CreateSketchFixSupTY1(RPArray<MbContour>& _arrContours, float L2, float B1, float h)
{
...
void CreateSketchFixSupTYCurve(RPArray<MbContour>& _ptrContours, float DV, float h)
{
...
SPtr<MbSolid> ParametricModelCreator::FixedSupHETU(BuildParams params)
{
    ...
    CreateSketchFixSupTY(arrContours, L2, B1, h);
    CreateSketchFixSupTY1(arrContours1, L2, B1, h);
    CreateSketchFixSupTYCurve(ptrContours, DV, h);
